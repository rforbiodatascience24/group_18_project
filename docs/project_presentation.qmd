...
![Age of femmale patients stratified by cancer status](../results/03_female_age_distribution.png)
...
<div class="fragment fragment-1">
  ![cp1](../results//pca_scree_plot.png)
</div>

<div class="fragment fragment-2">
  ![Cumulative](../results//cummulative.png)
</div>
:::
