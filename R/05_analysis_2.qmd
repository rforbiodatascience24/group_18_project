...
ggsave(file.path(results_data_path,"pca_scree_plot.png"), plot = pca_plot, width = 10, height = 6, dpi = 300)
...
ggsave(file.path(results_data_path,"cummulative.png"), plot = cummulative, width = 10, height = 6, dpi = 300)
...
ggsave(file.path(results_data_path,"heatmap.png"), plot = heatmap, width = 10, height = 6, dpi = 300)
...
ggsave(file.path(results_data_path,"pc1.png"), plot = pc1, width = 10, height = 6, dpi = 300)
...
ggsave(file.path(results_data_path,"pc2.png"), plot = pc2, width = 10, height = 6, dpi = 300)
...
ggsave(file.path(results_data_path,"scatter.png"), plot = scatter, width = 10, height = 6, dpi = 300)
