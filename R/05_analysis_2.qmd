...
This heatmap shows the top 10 contributing genes for the first four principal components in the female dataset. Positive loadings (red) and negative loadings (blue) highlight how each gene contributes to each PC.
