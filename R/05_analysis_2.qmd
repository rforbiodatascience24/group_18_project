...
ggsave(here("results","cummulative.png"), plot = cummulative, width = 10, height = 6, dpi = 300,bg = "white")
...
ggsave(here("results","heatmap.png"), plot = heatmap, width = 10, height = 6, dpi = 300,bg = "white")
...
ggsave(here("results","pc1.png"), plot = pc1, width = 10, height = 6, dpi = 300,bg = "white")
...
ggsave(here("results","pc2.png"), plot = pc2, width = 10, height = 6, dpi = 300,bg = "white")
...
ggsave(here("results","scatter.png"), plot = scatter, width = 10, height = 6, dpi = 300,bg = "white")
