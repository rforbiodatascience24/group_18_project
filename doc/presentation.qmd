...
![Enriched pathways](../results/04_top_10_enriched_pathways.png.jpeg)
...
<div class="fragment fragment-1">
  ![Explained variance](../results/pca_scree_plot.png)
</div>

<div class="fragment fragment-2">
  ![Cumulative variance](../results//cummulative.png)
</div>
:::
...
<div class="fragment fragment-1">
  ![Overlapped clustering of patients](../results/scatter.png)
</div>

<div class="fragment fragment-2">
  ![Different PCs are influenced by distinct sets of genes](../results/heatmap.png)
</div>
:::
